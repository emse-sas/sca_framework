...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"$ref_dir/../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/8b3d" \
       +incdir+"../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"../../../../vivado_sca.srcs/sources_1/bd/system/ipshared/8b3d" \
