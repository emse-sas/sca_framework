...
parser.leak.to_csv(os.path.join(DATA_PATH, "leak_%s_%d.csv" % FILE_ARGS))
...
plt.title("Raw power consumptions (iterations: %d, samples: %d, sensors: %d)" % plot_args)
...
plt.title("Average power consumption FFT (iterations: %d, samples: %d, sensors: %d)" % plot_args)
