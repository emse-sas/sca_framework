...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../simple_aes_driver.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../simple_aes_driver.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
       +incdir+"../../../../simple_aes_driver.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../simple_aes_driver.srcs/sources_1/bd/system/ipshared/6b56/hdl" \
